...
namespace MarkEzd
{
    public class MarkJcz : LoadDll
    {
        ...
        private static System.Timers.Timer mTimer = null;
        ...
        /// <returns></returns>
        public static bool GetParamByName(int nIndex, ref double dPowerRatio, ref int nFreq, ref double dMarkSpeed)
        {
        ...
        /// <param name="dSetCurrent"></param>
        /// <returns></returns>
        public static bool SetParamByName(int nIndex, double dSetPower, int nSetRate, double dSetMarkSpeed)
        {
            ...
            lmc1_SetPenParam(nPen, nMarkLoop, dSetMarkSpeed, dSetPower, dCurrent, nSetRate, dQPulseWidth,
...
//         public static bool GroupEntity(string strName1,string strName2,string strNewName,int nPenNo)
//         {
//             LmcErrCode Ret = LMC1_GROUPENT(strName1, strName2, strNewName, nPenNo);
//             if (LmcErrCode.LMC1_ERR_SUCCESS == Ret)
//                 return true;
//             else
//             {
...
//             }
//         }
//         public static bool UnGroupEnt(string strGroupName)
//         {
//             LmcErrCode Ret = LMC1_UNGROUPENT(strGroupName);
//             if (LmcErrCode.LMC1_ERR_SUCCESS == Ret)
//                 return true;
//             else
//             {

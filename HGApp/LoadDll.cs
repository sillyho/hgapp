...
namespace MarkEzd
{
    ...
    public class LoadDll
    {
        ...
        protected static extern LmcErrCode LMC1_INITIAL(string strEzCadPath, int bTestMode,        //是否是测试模式
                                    IntPtr hOwenWnd);
        ...
        protected static extern LmcErrCode lmc1_GetTextByName(string strEntName, char[] strText);
        #endregion
